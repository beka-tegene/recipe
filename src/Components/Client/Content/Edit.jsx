...
import { setUpdateRecipe } from "../../../Store/Hook/RecipeHook";
...
const EditPage = ({ dataEdit }) => {
  ...
  const [preparationSteps, setPreparationSteps] = useState(
    dataEdit.preparationSteps || ""
  );
  const [categories, setCategories] = useState(dataEdit.categories || "");
  const [minutes, setMinutes] = useState(dataEdit.minutes || "");
  const [cal, setCal] = useState(dataEdit.cal || "");
